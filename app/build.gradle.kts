...
dependencies {
    ...
    //voyager
    val voyager_version = "1.11.0-alpha"
    implementation ("io.github.raamcosta.compose-destinations:core:$voyager_version")
    ksp ("io.github.raamcosta.compose-destinations:ksp:$voyager_version")
    implementation ("io.github.raamcosta.compose-destinations:animations-core:$voyager_version")
